/*
 ...
 //Changes to architecture: 
   As of 12.10.15 The trackuino independently is working and the customized message appears on aprs.fi. This version removes any sort of serial 
   handshake as to minimize inter system realince on the Mega or the IMU.
...
String megaInput = "PAC: No data from Mega :("; //This is the input from the Mega
...
//Trackuino Section -- sends the next APRS frame
  ...
  if (arduinoSerial.available()){
   // Serial.println("we're in here"); 
    ...
    megaInput = "PAC: "; 
    megaInput.concat(arduinoSerial.readString());
